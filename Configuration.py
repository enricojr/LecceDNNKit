...
rootBranchSubSample= ['lep1_m', 'lep1_pt', 'lep1_eta', 'lep1_phi', 'lep2_m','lep2_pt', 'lep2_eta', 'lep2_phi', 'fatjet_m', 'fatjet_pt', 'fatjet_eta', 'fatjet_phi', 'fatjet_D2', 'NJets', 'weight', 'X_boosted_m', 'Zcand_m', 'Zcand_pt', 'Pass_MergHP_GGF_ZZ_Tag_SR', 'Pass_MergHP_GGF_ZZ_Untag_SR', 'Pass_MergLP_GGF_ZZ_Tag_SR', 'Pass_MergLP_GGF_ZZ_Untag_SR', 'Pass_MergHP_GGF_ZZ_Tag_ZCR', 'Pass_MergHP_GGF_ZZ_Untag_ZCR', 'Pass_MergLP_GGF_ZZ_Tag_ZCR', 'Pass_MergLP_GGF_ZZ_Untag_ZCR']
# EJS missing: isSignal, truth_zv_mass, isMerged, isCR, isVBFEvent, lep1_e turned to lep1_m, same for lep2 and fatjet, ll_xxx variables became Zcand_xxx
...
InputDNNVariables = [
        # MERGED - DNN
       # ['lep1_m', 'lep1_pt', 'lep1_eta', 'lep1_phi', 'lep2_m','lep2_pt', 'lep2_eta', 'lep2_phi', 'Zcand_m', 'Zcand_pt','fatjet_m', 'fatjet_pt', 'fatjet_eta', 'fatjet_phi','NJets'],

       # MERGED - pDNN
       ['lep1_m', 'lep1_pt', 'lep1_eta', 'lep1_phi', 'lep2_m','lep2_pt', 'lep2_eta', 'lep2_phi', 'Zcand_m', 'Zcand_pt', 'fatjet_m', 'fatjet_pt', 'fatjet_eta', 'fatjet_phi', 'NJets','truth_zv_mass'],

       # RESOLVED - pDNN
       # ['lep1_m', 'lep1_pt', 'lep1_eta', 'lep1_phi', 'lep2_m','lep2_pt', 'lep2_eta', 'lep2_phi', 'Zcand_m', 'Zcand_pt', 'jj_pt', 'jj_j1pt', 'jj_eta', 'jj_phi','jj_m', 'jj_j1eta', 'jj_j1phi', 'jj_j1M', 'jj_j1NTracks', 'jj_j2pt', 'jj_j2eta', 'jj_j2phi', 'jj_j2M', 'jj_j2NTracks', 'NJETS','truth_zv_mass'],
