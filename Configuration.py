...
# EJS IMPORTANT: the first item must be DSID, as this maps into the signal mass
...
# EJS missing: isSignal, truth_zv_mass changed to DSID, isMerged, isCR, isVBFEvent, lep1_e turned to lep1_m, same for lep2 and fatjet, ll_xxx variables became Zcand_xxx
...
InputDNNVariables = [
       ...
       # MERGED - pDNN
       ['DSID','lep1_m', 'lep1_pt', 'lep1_eta', 'lep1_phi', 'lep2_m','lep2_pt', 'lep2_eta', 'lep2_phi', 'Zcand_m', 'Zcand_pt', 'fatjet_m', 'fatjet_pt', 'fatjet_eta', 'fatjet_phi', 'NJets','truth_zv_mass'],
